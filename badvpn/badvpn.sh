...
fun_udp1 () {
    ...
    menu
	    ...
	    inst_udp () {
            ...
            wget https://www.dropbox.com/s/5i94xdpf1aed4j8/badvpn-udpgw -o /dev/null
			wget https://raw.githubusercontent.com/twossh/GESTOR/main/badvpn/antcrashvpn.sh -o /dev/null
